 ...
 *    }
 * 
 * 2. Add a label property for the review screen:
 *    QuestionColor.label = 'Color Scheme';
 * 
 * 3. Add a Review component to display the answer:
 *    QuestionColor.Review = function({ value }) {
 ...
 * 
 * 5. Add it to the questions array below:
 *    {
 *      id: 'color',
...
export default function Questionnaire() {
  ...
  const handleEditAnswer = (questionId) => {
    setShowReview(false);
    // User can navigate via Previous button
  };
